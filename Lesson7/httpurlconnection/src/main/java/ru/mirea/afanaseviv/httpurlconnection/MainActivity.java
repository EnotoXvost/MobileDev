package ru.mirea.afanaseviv.httpurlconnection;
...
import ru.mirea.afanaseviv.httpurlconnection.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    public class DownloadPageTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            binding.tvCity.setText("Loading");
        }
