package ru.mirea.afanaseviv.notificationapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickNewMessageNotification(View view){
        ...
        NotificationChannel channel = new NotificationChannel(CHANNEL_ID, "Student Afanasev Ilya Notification", importance);
